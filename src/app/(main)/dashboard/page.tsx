...
export default async function DashboardPage() {
  ...
  return (
    <PageContainer>
      ...
      <Section>
        <div className="p-4 bg-gradient-to-r from-slate-50 to-cyan-50 rounded-2xl border border-slate-200">
          <div className="flex items-start gap-3">
            <HelpCircle className="w-5 h-5 text-cyan-600 shrink-0 mt-0.5" />
            <div>
              <h3 className="text-sm font-medium text-slate-900">Como funciona a Antecipação?</h3>
      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          >
            {data.eligibleContracts.length === 0 ? (
              <p className="text-slate-500 py-4">Nenhum contrato elegível no momento</p>
            ) : (
                ...
                {data.lateInstallments.items.map((inst) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-slate-900">{inst.contract.endCustomer.name}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          >
            {data.upcomingInstallments.length === 0 ? (
              <p className="text-slate-500 py-4">Nenhuma parcela vencendo esta semana</p>
            ) : (
              <div className="divide-y divide-slate-100">
